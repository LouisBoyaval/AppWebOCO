...
<header>    
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            ...
            <a class="nav-item nav-link active" href="Pages/configuration.php">Configuration </a>
            <a class="nav-item nav-link" href="Pages/stat.php">Statistiques</a>
            <a class="nav-item nav-link" href="Pages/informations.php">Informations</a>
            </div>
        </div>
    </nav>
<header>
