            ...
            <div class="col-sm-4">
                ...
                <form method="post" action="../DatabaseCom/Croquettes.php">
                    <fieldset enabled>
                        ...
                        <div class="form-group">
                            <input name="qte" type="number" step="0.01" id="enabledTextInput" class="form-control" placeholder="Quantité totale distribuée (g)">
                        </div>
                        <button type="Envoyer" class="btn btn-primary">Envoyer</button>
                    </fieldset>
                    </form>
                    ...
                    <div class="form-group">
                        <select name="id" class="form-select" aria-label="Default select example">
                            ...
                            ?>
                                ...
                                <div class="form-group">
                                    <input name="quantite"  type="number" step="0.01" id="enabledTextInput" class="form-control" placeholder="Quantité (g)">
                                </div>
